...
% Auto-generated by MATLAB on 29-Mar-2019 15:15:09
...
predictorNames = {'Timestamp', 'VoltagemV'};
predictors = inputTable(:, predictorNames);
response = inputTable.Categories;
isCategoricalPredictor = [true, false];
...
trainedClassifier.RequiredVariables = {'Timestamp', 'VoltagemV'};
